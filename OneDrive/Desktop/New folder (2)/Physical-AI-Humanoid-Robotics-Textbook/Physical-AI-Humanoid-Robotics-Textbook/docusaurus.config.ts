...
const config: Config = {
  ...
  organizationName: 'ABDUR REHMAN RIZWAN',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'hafizabdurehman/Physical-AI-Humanoid-Textbook',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub',
              href: 'https://github.com/ABDUR-REHMAN-RIZWAN',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI & Humanoid Robotics. Built with  by ABDUR REHMAN RIZWAN`,
    },
    prism: {
